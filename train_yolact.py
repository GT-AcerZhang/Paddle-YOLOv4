...
def yolact_loss(args, num_classes, iou_loss_thresh, anchors):
...
if __name__ == '__main__':
    ...
    while True:  # 无限个epoch
        ...
        for step in range(train_steps):
            ...
            batch_image, batch_label, batch_gt_bbox, batch_gt_segment, batch_gt_mask, batch_label_idx = gt2YolactTarget(samples, context)
